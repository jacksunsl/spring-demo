package com.hipishare.spring.sample.aop;
...
public class AspectAdviceBeanUseAnnotation {
	...
	// 定义一个全局的Pointcut
	@Pointcut("execution(* com.study.mike.spring.sample.aop.*.do*(..))")
	public void doMethods() {
	}

	@Pointcut("execution(* com.study.mike.spring.sample.aop.*.service*(..))")
