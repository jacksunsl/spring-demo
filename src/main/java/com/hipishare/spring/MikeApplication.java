...
import com.hipishare.spring.ext.MyTypeFilter;
import com.hipishare.spring.sample.service.Abean;
...
public class MikeApplication {
	...
	public static void main(String[] args) {
		...
		new ClassPathBeanDefinitionScanner(context3).scan("com.study.mike.spring.service");
		// 一定要刷新
		context3.refresh();
